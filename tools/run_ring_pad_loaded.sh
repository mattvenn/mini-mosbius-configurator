#!/usr/bin/env bash
# Routed-onto-the-chip simulation of THIS PROJECT'S OWN ring oscillator
...
top = f"""* Routed-onto-the-chip testbench for examples/ringosc/ring.sch (bitstream {bitstream}).
