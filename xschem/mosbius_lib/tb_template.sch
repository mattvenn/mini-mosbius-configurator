...
T {Copy this next to your design, then replace my_design.sch and
my_design_routed everywhere below with your own names. Paths are
relative to the repo root, where you launched xschem.
x1 is your design as drawn, x2 the same design as routed onto the chip.
x2 needs a generated file: ctrl-click -generate routed spice-, then
press Netlist again. See examples/inverter/ for a worked version.} -530 -660 0 0 0.25 0.25 {}
...
C {devices/code_shown.sym} 140 -660 0 0 {name=NGSPICE only_toplevel=true value="
