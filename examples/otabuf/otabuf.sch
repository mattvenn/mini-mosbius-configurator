...
T {outp is left unconnected: tnt's part brings it to the switch matrix,} -450 60 0 0 0.3 0.3 {}
T {Andrew Kang's keeps it internal, and one schematic has to work on both.} -450 90 0 0 0.3 0.3 {}
