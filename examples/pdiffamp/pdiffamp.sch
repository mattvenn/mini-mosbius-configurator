...
N 20 260 20 230 {lab=VGND}
N 20 260 220 260 {lab=VGND}
N 220 260 220 230 {lab=VGND}
...
C {mosbius_pmos.sym} 0 0 0 0 {name=M1 w=4}
C {mosbius_pmos.sym} 200 0 0 0 {name=M2 w=4}
C {mosbius_ptail.sym} 100 -150 0 0 {name=T1 tail=4}
C {mosbius_nmos.sym} 0 200 0 0 {name=M3 w=1}
C {mosbius_nmos.sym} 200 200 0 0 {name=M4 w=1}
...
C {devices/iopin.sym} -300 -140 0 0 {name=p4 lab=VAPWR}
C {devices/iopin.sym} -300 -100 0 0 {name=p4b lab=VDPWR}
C {devices/iopin.sym} 20 260 0 1 {name=p4c lab=VGND}
