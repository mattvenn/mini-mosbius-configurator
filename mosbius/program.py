...
# Whether this design has a reset to drive at all. tnt's has none, and
# pulsing one that is not there is silent rather than harmless-looking.
HAS_RESET = {has_reset!r}
PROJECT = {project!r}
DO_RESET = {reset!r}
DO_VERIFY = {verify!r}
